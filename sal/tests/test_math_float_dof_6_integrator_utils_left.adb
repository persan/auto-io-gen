...
with SAL.Math_Float.DOF_6.Integrator_Utils.Left; use SAL.Math_Float.DOF_6.Integrator_Utils.Left;
...
package body Test_Math_Float_DOF_6_Integrator_Utils_Left
is
   use SAL.Math_Float;
   ...
   is
      ...
      procedure Runge_Kutta is new SAL.Math_Float.Gen_Runge_Kutta_4th_Left
        (State_Type                 => State_Type,
         Derivative_Type            => State_Dot_Type,
         Compute_Derivative         => Compute_Derivative,
         Derivative_Plus_Derivative => Derivative_Plus_Derivative,
         State_Plus_Derivative      => State_Plus_Derivative,
   ...
   begin
      ...
      Check ("1.Rot", To_Rot_Vector (CM_State.Rotation), (0.00,  0.00,  0.00));
      Check ("1.tran_mom", CM_State.CM_Tran_Mom, (0.0,  0.0,  0.0));
      Check ("1.rot_mom", CM_State.CM_Rot_Mom, (0.00,  0.00,  0.20));

      Zero_Force_Integrator (CM_State, Inverse_Mass, 0.1);
      Check ("2.Tran", CM_State.Translation, (0.00,  0.00,  0.00));
      Check ("2.Rot", To_Rot_Vector (CM_State.Rotation), (0.00,  0.00,  0.01));
      ...
      Check ("3.Rot", To_Rot_Vector (CM_State.Rotation), (0.00,  0.00,  0.02));
      ...
      Check ("4.Rot", To_Rot_Vector (CM_State.Rotation), (0.00,  0.00,  0.03));
   ...
   is
      ...
      Mass : constant CM_Mass_Type :=
           (Total          => 5.0,
            Center_Inertia => ((1.0, 1.0, 2.0, 0.0, 0.0, 0.0)));
      --  Translation acceleration = wrench/mass = 0.02
   ...
   begin
      ...
      Check ("1.rot_mom", CM_State.CM_Rot_Mom, (0.00,  0.00,  0.090));
      ...
      Check ("2.rot_mom", CM_State.CM_Rot_Mom, (0.00,  0.00,  0.080));
      ...
      Check ("3.rot_mom", CM_State.CM_Rot_Mom, (0.00,  0.00,  0.070));
      ...
      Check ("4.rot_mom", CM_State.CM_Rot_Mom, (0.00,  0.00,  0.060));
   ...
   is
      ...
      --  CM_Rot_Mom is in CM frame; cm_mom_cm
   ...
   begin
      ...
      Check ("1.rot_mom", CM_State.CM_Rot_Mom, (0.000, -0.00237,  0.090));
      ...
      Check ("2.rot_mom", CM_State.CM_Rot_Mom, (0.000, -0.004496,  0.07977));
      ...
      Check ("3.rot_mom", CM_State.CM_Rot_Mom, (0.000, -0.00636,  0.06949));
      ...
      Check ("4.rot_mom", CM_State.CM_Rot_Mom, (0.000, -0.008,  0.059135));
      ...
      Check ("5.rot_mom", CM_State.CM_Rot_Mom, (0.000, -0.0093176,  0.0487));
      ...
      Check ("6.rot_mom", CM_State.CM_Rot_Mom, (0.000108, -0.010404,  0.038207));
   ...
   begin
      ...
      Check
        ("1.Base_rot_mom", Base_R_CM * CM_State.CM_Rot_Mom, Rotation (Base_Momentum_Init));
      Check ("1.tran_mom", CM_State.CM_Tran_Mom, (0.0, 0.0, 0.0));
      ...
      Check
        ("2.Base_rot_mom", Base_R_CM * CM_State.CM_Rot_Mom, Rotation (Base_Momentum_Init));
   ...
   is
      ...
      CM_State : State_Type :=
        (Translation => Zero_Cart_Vector,
         ...
         CM_Tran_Mom => Translation (Base_Momentum_Init),
         CM_Rot_Mom  => Rotation (Base_Momentum_Init));
      --  CM_State.Rotation is active Base_Q_CM
   ...
   begin
      ...
      Integrator (CM_State, Inverse_Mass, Time_Step);
      Check ("1.Tran", CM_State.Translation, (2.00000E-04,  0.00000E+00,  0.00000E+00));
      Check ("1.Rot", CM_State.Rotation, To_Unit_Quaternion (0.00000,   0.00002,   0.00050,   1.00000));
      Check ("1.tran_mom_mag", Mag (CM_State.CM_Tran_Mom), Momentum_Mag (Tran));
      Check ("1.rot_mom_mag", Mag (CM_State.CM_Rot_Mom), Momentum_Mag (Rot));
      Check
      ...
      Check ("2.Rotation", CM_State.Rotation, To_Unit_Quaternion (0.00272,   0.02282,   0.47990,   0.87703));
      Check ("2.tran_mom_mag", Mag (CM_State.CM_Tran_Mom), Momentum_Mag (Tran));
      Check ("2.rot_mom_mag", Mag (CM_State.CM_Rot_Mom), Momentum_Mag (Rot));
      Check
        ("2.Base_rot_mom", Base_R_CM * CM_State.CM_Rot_Mom, Rotation (Base_Momentum_Init));
   ...
   is
      pragma Unreferenced (T);
   begin
      return new String'("Test_Math_Float_DOF_6_Integrator_Utils_Left");
   end Name;
...
end Test_Math_Float_DOF_6_Integrator_Utils_Left;

--  Abstract :
--
--  Test SAL.Gen.Alg.Find_Linear, with Unbounded_Arrays
--
...
package Test_Poly_Unbounded_Arrays_Find_Linear is

   type Test_Case (Debug_Level : Integer) is new AUnit.Test_Cases.Test_Case with null record;

...
with Test_Simple_Function_Tables_Monotonic_First_Order_Aux;
procedure Test_Simple_Function_Tables_Monotonic_First_Order is

   use Test_Simple_Function_Tables_Monotonic_First_Order_Aux.First_Order_Monotonic_Float_Function_Tables;

   Table : aliased constant
      Test_Simple_Function_Tables_Monotonic_First_Order_Aux.Float_Function_Tables.Table_Type :=
      (1 => (1.0, 2.0),
       2 => (2.0, 2.5),
       3 => (2.5, 3.0),
       4 => (3.0, 4.0));
...
end Test_Simple_Function_Tables_Monotonic_First_Order;

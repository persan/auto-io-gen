--  Abstract
--
--  Declarations to help test SAL.Gen.Lists.Double.
--
--  Since we are in the Gen tree, not the Poly tree, we don't use any
--  tagged types (except for Node_Storage_Pool).
--
...
with SAL.Gen.Lists.Double.Validate;
...
package Test_Gen_Lists_Double_Aux is
   ...
   package Integers is
      ...
      package Lists is new SAL.Gen.Lists.Double
         (Item_Type         => Integer,
      ...
      package Algorithms is new SAL.Gen.Alg
         (Item_Node_Type => Integer,
          ...
          First          => Iterators.First,
          Last           => Iterators.Last,
          None           => Iterators.None,
          Is_Null        => Iterators.Is_Null,
          Next_Function  => Iterators.Next,
          Next_Procedure => Iterators.Next);

...
procedure Time_Simple_Function_Tables_Monotonic_First_Order is

   package Aux renames Test_Simple_Function_Tables_Monotonic_First_Order_Aux;
...
begin
   ...
   Aux.Free (Aux.Table);
end Time_Simple_Function_Tables_Monotonic_First_Order;

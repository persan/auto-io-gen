...
package body Test_Math_Float_Gen_Runge_Kutta_4th_Wertz is
   ...
   begin
      return new String'("Test_Math_Float_Gen_Runge_Kutta_4th_Wertz");
   end Name;
   ...
   is
      ...
      procedure Constant_Integrator is new SAL.Math_Float.Gen_Runge_Kutta_4th_Wertz
   ...
   is
      ...
      procedure Linear_Integrator is new SAL.Math_Float.Gen_Runge_Kutta_4th_Wertz
         (State_Type                 => Real_Type,
          Derivative_Type            => Real_Type,
          Compute_Derivative         => State_Derivative,
          Derivative_Times_Time      => "*",
   ...
   is
      ...
      procedure Quadratic_Integrator is new SAL.Math_Float.Gen_Runge_Kutta_4th_Wertz
         (State_Type                 => Real_Type,
          Derivative_Type            => Real_Type,
          Compute_Derivative         => State_Derivative,
          Derivative_Times_Time      => "*",
...
end Test_Math_Float_Gen_Runge_Kutta_4th_Wertz;

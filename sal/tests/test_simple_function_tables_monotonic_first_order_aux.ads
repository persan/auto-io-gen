...
package Test_Simple_Function_Tables_Monotonic_First_Order_Aux is
   package Float_Function_Tables is new SAL.Simple.Function_Tables (Float, Float);
...
end Test_Simple_Function_Tables_Monotonic_First_Order_Aux;

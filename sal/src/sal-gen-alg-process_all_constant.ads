--  Abstract :
--
--  Read only access to all items in a container.
--
...
generic
   with procedure Pre_Process_Container (Container : in Container_Type) is Do_Nothing;
   with procedure Process_Item
      (Item  : in Item_Node_Type;
       First : in Boolean := True);
   with procedure Post_Process_Container (Container : in Container_Type) is Do_Nothing;

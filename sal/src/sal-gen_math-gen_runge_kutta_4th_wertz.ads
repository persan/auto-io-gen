--  Abstract :
--
--  Generic Runge-Kutta fourth order integrator, with right-multiply
--  convention for derivative plus state.
--
--  See SAL.Gen_Math.Gen_Runge_Kutta_4th_Left for left-multiply
--  convention.
--
...
generic
   ...
   with function Derivative_Plus_State (Derivative : in Derivative_Type; State : in State_Type) return State_Type is <>;
...
pragma Pure (SAL.Gen_Math.Gen_Runge_Kutta_4th_Wertz);

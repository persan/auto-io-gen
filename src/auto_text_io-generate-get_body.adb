...
package body Auto_Text_IO.Generate.Get_Body is
   use Ada.Text_IO;
   ...
   procedure Generate_Discriminant_Declare
      (File         : in Ada.Text_IO.File_Type;
       Discriminant : in Auto_Text_IO.Lists.Component_Type);
   ...
   procedure Generate_Component_Temp_Get
      (File      : in Ada.Text_IO.File_Type;
       Component : in Auto_Text_IO.Lists.Component_Type);
   ...
   procedure Generate_Record
      (File            : in Ada.Text_IO.File_Type;
       Type_Descriptor : in Auto_Text_IO.Lists.Record_Type_Descriptor_Type);
   ...
   is
      ...
      procedure Print_Discriminant_Declares is new Auto_Text_IO.Lists.Component_Algs.Process_All_Constant
      ...
      procedure Print_Discriminants is new Auto_Text_IO.Lists.Component_Algs.Process_All_Constant
      ...
      procedure Print_Discriminant_Compares is new Auto_Text_IO.Lists.Component_Algs.Process_All_Constant
      ...
      procedure Print_Discriminant_Gets is new Auto_Text_IO.Lists.Component_Algs.Process_All_Constant
      ...
      procedure Print_Component_Gets is new Auto_Text_IO.Lists.Component_Algs.Process_All_Constant
...
end Auto_Text_IO.Generate.Get_Body;

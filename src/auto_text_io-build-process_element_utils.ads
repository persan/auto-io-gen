...
--
private package Auto_Text_IO.Build.Process_Element_Utils is
   ...
   --  auto_text_io : " (ignoring whitespace). The word following the
...
end Auto_Text_IO.Build.Process_Element_Utils;

...
package Auto_Text_IO.Lists is
   ...
   type Type_Descriptor_Type (Label : Type_Labels_Type) is record
      ...
      --  auto_text_io : separate"; user provides a separate
      --  subprogram for the basic Put and Get; Auto_Text_IO generates
      --  calls to them.

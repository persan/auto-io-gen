...
with Asis.Elements;
procedure Auto_Io_Gen.Build.Create_Invisible_Type_List (State : in out State_Type; Element : in Asis.Element)
is
   use Ada.Characters.Handling;

   Visible_Type_Tree : Auto_Io_Gen.Lists.Name_Trees.Tree_Type;
...
end Auto_Io_Gen.Build.Create_Invisible_Type_List;

...
with Auto_Text_IO.Build.Process_Element_Do_Initial;
with Auto_Text_IO.Build.Process_Element_Do_Package;
with Auto_Text_IO.Build.Process_Element_Do_Formal_Package;
with Auto_Text_IO.Build.Process_Element_Do_Type;
with Auto_Text_IO.Build.Process_Element_Do_Array_Type;
with Auto_Text_IO.Build.Process_Element_Do_Discriminant_Part;
with Auto_Text_IO.Build.Process_Element_Do_Discriminant;
with Auto_Text_IO.Build.Process_Element_Do_Record_Type;
with Auto_Text_IO.Build.Process_Element_Do_Variant_Part;
with Auto_Text_IO.Build.Process_Element_Do_Component;
with Auto_Text_IO.Build.Process_Element_Do_Component_Definition;
package body Auto_Text_IO.Build is
   ...
   is begin
      if Auto_Text_IO.Options.Debug then
         if New_Line then

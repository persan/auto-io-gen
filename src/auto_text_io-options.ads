...
with Ada.Text_IO;
package Auto_Text_IO.Options is
   ...
   --  If True, use Ada 83 syntax for output file; _Text_IO instead of
   --  .Text_IO, etc.

   Ada_12 : Boolean := False;
   --  If True, allow Ada 12 syntax in source file

...
package Auto_Text_IO.Generate is
--   pragma Elaborate_Body; -- Body depends on Text_IO, but this is circular due to child packages.
   ...
   procedure Create_Text_IO_Child
     (Type_List           : in Auto_Text_IO.Lists.Type_Descriptor_Lists.List_Type;
      Spec_With_List      : in Auto_Text_IO.Lists.Context_Trees.Tree_Type;
      Body_With_List      : in Auto_Text_IO.Lists.Context_Trees.Tree_Type;

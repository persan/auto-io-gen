...
with Asis.Aux;
with Asis.Elements;
with Auto_Text_IO.Generate.Get_Body;
with Auto_Text_IO.Generate.Put_Body;
with Auto_Text_IO.Generate.Spec;
with Auto_Text_IO.Options;
with SAL.Gen.Alg.Process_All_Constant;
package body Auto_Text_IO.Generate is
   ...
   procedure Generate_Child_Body
     (File                : in Ada.Text_IO.File_Type;
      Type_List           : in Auto_Text_IO.Lists.Type_Descriptor_Lists.List_Type;
      With_List           : in Auto_Text_IO.Lists.Context_Trees.Tree_Type;
   ...
   is
      ...
      is
         ...
         use Auto_Text_IO.Lists.Context_Trees_Iterators;
         Iterator             : Iterator_Type := First (With_List);
         Have_Use_Ada_Text_IO : Boolean       := False;
      begin
         Put_Line (File, "--  Abstract :");
         Put_Line (File, "--");
         Put_Line (File, "--  See spec. This file is auto-generated by " & Auto_Text_IO.Program_Name);
   ...
   begin
      ...
      Set_Col (File, 1 + Auto_Text_IO.Options.Indent * (Indent_Level - 1));
   end Set_Indent;

end Auto_Text_IO.Generate;
